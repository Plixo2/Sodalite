package io.github.plixo2.sodalite.category.scancode;
...
public enum Scancode {
    ...
    private static final Map<Integer, Scancode> codeMap = Arrays.stream(values()).collect(
            Collectors.toMap(Scancode::code, Function.identity())
    );
