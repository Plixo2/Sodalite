...
public enum Keycode {
    ...
    public static final int EXTENDED_MASK = SDLK_EXTENDED_MASK();
    public static final int SCANCODE_MASK = SDLK_SCANCODE_MASK();

    private static final Map<Integer, Keycode> codeMap = Arrays.stream(values()).collect(
            Collectors.toMap(Keycode::code, Function.identity())
    );
